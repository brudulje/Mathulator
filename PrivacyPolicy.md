...
This privacy policy applies to the Mathulator app (hereby referred to as "Application") for mobile devices that was created by Joachim Seland Graff (hereby referred to as "Service Provider"). This service is intended for use "AS IS".
